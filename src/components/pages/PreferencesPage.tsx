...
import { Settings, Globe, Info, Monitor } from 'lucide-react';
...
const PreferencesPage: React.FC = () => {
  ...
  const windowsVersionText = systemInfo.windowsVersion === 'win11' ? 'Windows 11' : 'Windows 10';
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="setting-card">
          <div className="flex items-center mb-4">
            <Monitor className="w-5 h-5 text-secondary-400 mr-2" />
          ...
          <div className="space-y-3">
            <div>
              ...
              <p className="text-base text-white">{windowsVersionText}</p>
            </div>
          </div>
        </div>
